...
CREATE TABLE soil_emsl_jgi_mt (
	...
	PRIMARY KEY (rna_cont_well, rna_concentration, rna_volume, rna_absorb1, rna_absorb2, rna_seq_project, rna_seq_project_name, "rna_samp_ID", rna_sample_name, "rna_container_ID", rna_organisms, rna_collect_site, rna_isolate_meth, "rna_seq_project_PI", rna_project_contact, proposal_rna, rna_cont_type, rna_sample_format, dnase_rna)
);
