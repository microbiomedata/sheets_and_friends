...
CREATE TABLE soil_emsl_jgi_mt (
	...
	PRIMARY KEY (dnase_rna, rna_absorb2, rna_absorb1, rna_collect_site, rna_concentration, "rna_container_ID", rna_cont_type, rna_organisms, rna_isolate_meth, proposal_rna, rna_sample_format, "rna_samp_ID", rna_sample_name, rna_project_contact, rna_seq_project, rna_seq_project_name, "rna_seq_project_PI", rna_volume, rna_cont_well)
);
